...
class TestLoadCurriculumSuccess:
    ...
    def test_loads_real_curriculum_file(self) -> None:
        """The real curriculum.json file should load with the expected structure."""
    ...
    def test_days_have_type_and_objectives(self) -> None:
        """Every day entry should have a type and objectives."""
        curriculum = load_curriculum()
...
class TestLoadCurriculumFailures:
    ...
    def test_modules_not_list_raises(self, tmp_path) -> None:
        ...
        with pytest.raises(DataLoadError, match="'modules' must be a list"):
            load_curriculum(p)
    ...
    def test_module_missing_keys_raises(self, tmp_path) -> None:
        ...
        with pytest.raises(DataLoadError, match="modules\\[0\\].*missing required key"):
            load_curriculum(p)
    ...
    def test_day_missing_keys_raises(self, tmp_path) -> None:
        ...
        with pytest.raises(DataLoadError, match="days\\[0\\].*missing required key"):
            load_curriculum(p)